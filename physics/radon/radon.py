...
from .filters import RampFilter, HannFilter, LearnableFilter
...
if __name__ == '__main__':
    ...
    sino = r(img)
    reco = ir(sino)
    # print(sino.shape, torch.min(reco))
    ...
    plt.subplot(1,3,2)
    plt.imshow(sino.numpy().squeeze(), cmap='gray')
    plt.subplot(1,3,3)
    plt.imshow(reco.detach().numpy().squeeze(), cmap='gray')
    plt.show()